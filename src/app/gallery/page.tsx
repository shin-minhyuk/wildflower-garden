...
import { ArrowDown, X, ChevronLeft, ChevronRight, ZoomIn } from "lucide-react";

// Types
type GalleryCategory = "experience" | "field" | "garden" | "rest";

const galleryData: Record<GalleryCategory, { src: string; alt: string; caption: string }[]> = {
  experience: [
    { src: "/image/gallary_2.webp", alt: "체험 1", caption: "흙을 만지며 느끼는 자연의 숨결" },
    { src: "/image/gallary_3.webp", alt: "체험 2", caption: "고사리 손으로 심는 희망" },
    { src: "/image/gallary_4.webp", alt: "체험 3", caption: "친구들과 함께하는 즐거운 시간" },
    { src: "/image/gallary_5.webp", alt: "체험 4", caption: "오감으로 배우는 생태 학습" },
    { src: "/image/gallary_6.webp", alt: "체험 5", caption: "자연 재료로 만드는 작품" },
    { src: "/image/gallary_7.webp", alt: "체험 6", caption: "웃음꽃 피어나는 체험장" },
  ],
  field: [
    { src: "/image/gallary_6.webp", alt: "텃밭 1", caption: "계절마다 달라지는 텃밭 풍경" },
    { src: "/image/gallary_5.webp", alt: "텃밭 2", caption: "직접 기른 작물의 기쁨" },
    { src: "/image/gallary_4.webp", alt: "텃밭 3", caption: "생명의 신비를 배우는 곳" },
    { src: "/image/gallary_2.webp", alt: "텃밭 4", caption: "땀방울로 일구는 결실" },
  ],
  garden: [
    { src: "/image/gallary_3.webp", alt: "정원 1", caption: "사계절 아름다운 들꽃 정원" },
    { src: "/image/gallary_2.webp", alt: "정원 2", caption: "꽃향기 가득한 산책로" },
    { src: "/image/gallary_7.webp", alt: "정원 3", caption: "자연이 그린 한 폭의 그림" },
    { src: "/image/gallary_6.webp", alt: "정원 4", caption: "바람이 머무는 곳" },
    { src: "/image/gallary_5.webp", alt: "정원 5", caption: "나비와 벌이 춤추는 화단" },
  ],
  rest: [
    { src: "/image/gallary_4.webp", alt: "쉼터 1", caption: "나무 그늘 아래 편안한 휴식" },
    { src: "/image/gallary_7.webp", alt: "쉼터 2", caption: "일상의 짐을 내려놓는 시간" },
    { src: "/image/gallary_3.webp", alt: "쉼터 3", caption: "가족과 함께하는 소풍" },
    { src: "/image/gallary_2.webp", alt: "쉼터 4", caption: "새소리 들으며 멍때리기" },
  ],
};
            ...
            {(Object.keys(tabLabels) as GalleryCategory[]).map((key) => (
                <button
                  ...
                  className={`flex-1 min-w-[100px] py-5 text-center transition-colors relative group whitespace-nowrap px-4 ${
                    activeTab === key ? "text-[#2E5C3C]" : "text-gray-400 hover:text-gray-600"
                  }`}
                >
                    <span className="text-lg font-bold block mb-1">{tabLabels[key].label}</span>
                    {activeTab === key && (
                  ...
                  >
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4">
                          <div className="text-center text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                              <p className="font-gowun-batang text-lg font-bold mb-2">{img.alt}</p>
